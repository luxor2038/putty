...
CONF_OPTION(ping_keepalive_max,
    VALUE_TYPE(INT),
    DEFAULT_INT(0),
    DEFAULT_BOOL(true),
    SAVE_KEYWORD("PingKeepaliveMax"),
)
...
CONF_OPTION(proxy_keyfile,
    VALUE_TYPE(FILENAME),
    SAVE_KEYWORD("ProxyKeyfile"),
)
CONF_OPTION(proxy_ssh_connection_sharing,
    VALUE_TYPE(BOOL),
    DEFAULT_BOOL(false),
    SAVE_KEYWORD("ProxyConnectionSharing"),
)
